...
artists_batch = [
    "Medicine", "Maiia", "Solar Spectrum", "Sabaii Sabaii", "1200 Mics by Chicago",
    "Lucas", "Kala", "Janux", "Kia Goa", "Dark Elf"
]

result_file = Path("/Users/vadim/.claude/projects/-Users-vadim-Projects-sola-luna/4ecaa012-1bc0-4d8e-a29f-147dd6b05a85/tool-results/mcp-brightdata-prod-search_engine_batch-1767035778102.txt")
